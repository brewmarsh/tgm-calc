...
Users can upload screenshots of their game data and have it automatically parsed and added to their profile. The screenshot analysis is done using the `pytesseract` library.
